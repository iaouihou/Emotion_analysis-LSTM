...
class weibo_spider(wbTool):
    ...
    def getContent(self):
        ...
        :return:
        """
        response = requests.get(self.url, headers=WEIBOCONTENT_HEADERS,verify=False)  # 带上请求头模拟浏览器 请求微博内容
